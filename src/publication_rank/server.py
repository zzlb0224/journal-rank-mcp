...
from publication_rank.database import search_journal, lookup_issn, add_journal
from publication_rank.fetcher import fetch_journal
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    if name == "query_journal":
        ...
        from publication_rank.database import _load_journals
